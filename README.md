...
# Необходимое количество эпох обучения зависит от сложности вычислительных операций: быстрее всего обучение реализуется для операций "Or" и "And". Операция "Xor" не поддаётся обучению, поскольку нелинейна.
