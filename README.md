...
Перцептрон не смог научиться производить вычисления даже спустья 100 итераций, поскольку операция нелинейная, а перцетрон может обучиться только линейным вычисленияем.
